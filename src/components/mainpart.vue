        ...
        <v-container style="padding: 20px">
          ...
          <v-card-text>
            <p class="body-1">
              ...
              gear drive. For the selection of the motor we used a 42 stepper
              motor, configured with a 1.8 degree stepping angle and with 16
              subdivisions.
            </p>
            <p class="body-1">【此处应有图,但是没拍】</p>
            <p class="body-1">
              A 13mm diameter gear is fixed to the motor shaft, and the motor
              gear drive can drive the belt, which moves the fixing frame and
              allows the drug release device to move to the desired position.
            </p>
            <p class="body-1">
              ...
              energized, so that the motor forward / reverse rotation, or
              locked.
            </p>
            <p class="body-1">
              Take our 1.8 degree two-phase stepper motor as an example: when
              both phase windings are energized and excited, the motor output
              shaft will be stationary and locked in position. The maximum
              torque that will keep the motor locked at the rated current is the
              holding torque. If the current in one of the phase windings
              changes direction, the motor will rotate one step (1.8 degrees) in
              a given direction. Similarly, if the current in the other winding
              changes direction, the motor will rotate one step (1.8 degrees) in
              the opposite direction of the former. When the currents through
              the coil windings are sequentially redirected to excitation, the
              motor will rotate in a continuous step in the given direction with
              very high accuracy. For a 1.8 degree two-phase stepper motor, it
              takes 200 steps to rotate one week.
            </p>
            <p class="body-1">
              At the same time we are equipped with 16 subdivision, subdivision
              is actually an electronic damping technology on the stepper motor,
              ...
              subdivision as an example, after 16 pulses, the motor turns
              through 1.8 degrees.
            </p>
            <p class="body-1">
            ...
            <p class="body-1">
              The signal levels corresponding to the voltage ON and OFF cases
              are called "H" and "L", respectively.
            </p>
